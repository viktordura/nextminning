            ...
            <div class="col-lg-5 col-md-7">
                <div class="card bg-secondary shadow border-0">
                    <div class="card-header bg-transparent pb-5">
                        <div class="text-muted text-center mt-2 mb-3"><small>{{ __('Inciar sesión con tu correo y contraseña') }}</small></div>
                    </div>
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <form role="form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary my-4">{{ __('Inciar sesión') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="col-6">
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-light">
                                <small>{{ __('Recordar contaseña?') }}</small>
                            </a>
                        @endif
                    </div>
